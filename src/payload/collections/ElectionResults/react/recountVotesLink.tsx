...
export const RecountVotesLink: React.FC = () => {
  ...
  return (
    <Fragment>
      <p>
        Before publishing ensure no nominee has won 2 or more positions,
        if they have contact them and ask which one they want to keep.
        The unwanted nomination should be set to dropped out and then
        the vote recounted.
      </p>
      <a
      ...
      <p></p>
      <p>
        Once this has be done for all positions you are safe to publish the changes.
      </p>
    </Fragment>
  );
};
